...
export class LibraryList extends Component {
  ...
  //      const categoryLabel2 = "label2";
        ...
        console.log(game);
          game = getGameDataObject(result[i].name, "/games/", "informations sur le jeu", "https://api.dune-table.com/files/apps/" + result[i].picPath, result[i].creator, categoryLabel1, etat);
          tmp.push(game);
        }
